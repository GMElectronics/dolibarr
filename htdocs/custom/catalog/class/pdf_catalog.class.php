    ...
    public function Body(&$pdf, $lines, $outputlangs, $footer, $divise=0)
    {
        ...
        for ($j = 0; $j < $numlines; $j++)
		{
			...
			*/
			...
			$pdf->Cell($this->page_largeur - $this->marge_gauche - $this->marge_droite, 2, $nameproduit.$price, 0, 0, 'L', 1);
			$pdf->Cell($this->page_largeur - $this->marge_gauche - $this->marge_droite, 2, $price, 0, 2, 'R', 0); // Product name
